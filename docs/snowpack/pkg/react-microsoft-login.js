    ...
    ResponseUtils.buildAuthResponse = function (idToken, authResponse, serverAuthenticationRequest, account, scopes, accountState) {
        switch (serverAuthenticationRequest.responseType) {
            case ResponseTypes.id_token:
                authResponse = __assign({}, authResponse, { tokenType: ServerHashParamKeys.ID_TOKEN, account: account, scopes: scopes, accountState: accountState });
...
var libEs6 = /*#__PURE__*/Object.freeze({
    ...
    Account: Account,
    Constants: Constants,
    get ServerHashParamKeys () { return ServerHashParamKeys; },
    Authority: Authority,
...
var getUserAgentApp = function (_a) {
    ...
    if (clientId && CLIENT_ID_REGEX.test(clientId)) {
        return new libEs6.UserAgentApplication({
...
var MicrosoftLogin_1 = createCommonjsModule(function (module, exports) {
var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
...
var MicrosoftLoginButton_1$1 = __importDefault(MicrosoftLoginButton_1);

var MicrosoftLogin = function (_a) {
    var graphScopes = _a.graphScopes, clientId = _a.clientId, tenantUrl = _a.tenantUrl, redirectUri = _a.redirectUri, children = _a.children, buttonTheme = _a.buttonTheme, className = _a.className, _b = _a.withUserData, withUserData = _b === void 0 ? false : _b, authCallback = _a.authCallback, _c = _a.forceRedirectStrategy, forceRedirectStrategy = _c === void 0 ? false : _c, prompt = _a.prompt, debug = _a.debug;
    var msalInstance = helpers.getUserAgentApp({ clientId: clientId, tenantUrl: tenantUrl, redirectUri: redirectUri });
    var scopes = helpers.getScopes(graphScopes);
    var log = helpers.getLogger(debug);
    if (!msalInstance) {
    ...
    var login = function () {
        log("Login STARTED");
        if (forceRedirectStrategy || helpers.checkToIE()) {
            redirectLogin();
        }
        else {
            popupLogin();
    ...
    var finalStep = function (authResponseWithAccessToken) {
        log("Fetch Graph API 'access_token' SUCCEDEED", authResponseWithAccessToken);
        if (withUserData) {
    ...
    return children ? (react_1.default.createElement("div", { onClick: login }, children)) : (react_1.default.createElement(MicrosoftLoginButton_1$1.default, { buttonTheme: buttonTheme || "light", buttonClassName: className, onClick: login }));
};
...
var MicrosoftLogin_1$1 = __importDefault(MicrosoftLogin_1);
exports.MicrosoftLogin = MicrosoftLogin_1$1.default;
exports.default = MicrosoftLogin_1$1.default;
